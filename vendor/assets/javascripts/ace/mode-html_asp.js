...
define("ace/mode/html_asp_highlight_rules",["require","exports","module","ace/lib/oop","ace/mode/html_highlight_rules","ace/mode/asp_highlight_rules"], function(require, exports, module) {
"use strict";
...
var HtmlAspHighlightRules = function() {
    ...
    this.embedRules(AspHighlightRules, "asp-", endRules, ["start"]);
...
HtmlAspHighlightRules.metaData = {
    fileTypes: ["asp"],
    ...
    keyEquivalent: "^~A",
    name: "HTML (ASP)",
    scopeName: "asp.html.asp"
}

oop.inherits(HtmlAspHighlightRules, HtmlHighlightRules);

exports.HtmlAspHighlightRules = HtmlAspHighlightRules;
...
define("ace/mode/html_asp",["require","exports","module","ace/lib/oop","ace/mode/html_asp_highlight_rules","ace/mode/html","ace/mode/javascript","ace/mode/css","ace/mode/asp","ace/mode/folding/cstyle"], function(require, exports, module) {
"use strict";

var oop = require("../lib/oop");
var HtmlAspHighlightRules = require("./html_asp_highlight_rules").HtmlAspHighlightRules;
var HtmlMode = require("./html").Mode;
var JavaScriptMode = require("./javascript").Mode;
var CssMode = require("./css").Mode;
var AspMode = require("./asp").Mode;
var FoldMode = require("./folding/cstyle").FoldMode;

var Mode = function() {
    HtmlMode.call(this);
    
    this.HighlightRules = HtmlAspHighlightRules;
    this.foldingRules = new FoldMode();
    this.createModeDelegates({
        "js-": JavaScriptMode,
        "css-": CssMode,
