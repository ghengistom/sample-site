...
var VBScriptHighlightRules = function() {
    ...
    "start": [
        ...
        },
        {
            ...
            regex: "Dim|Call|Class|Const|Dim|Redim|Function|Sub|Private Sub|Public Sub|End sub|End Function|Let|Randomize|Option Explicit|On Error Resume Next|On Error GoTo",
            caseInsensitive: true
        },
        {
            token: "storage.type.asp",
