...
<%%
Dim strPath, asdf, intOpenOutputFile, intOpenInputFile, _
 isDebug, strTitle, textWidth, testVar, _
 intCopyForm, intStartPrinting, some_var, intLinearizeFile, _
 grade, count, currentPage
