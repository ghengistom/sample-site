...
Public Class Examples
  Sub Example()
    Dim strPath As String, asdf As String, intOpenOutputFile As Integer, intOpenInputFile As Integer, _
      isDebug As Boolean, strTitle As String, textWidth As Single, testVar As Integer, _
      intCopyForm As Integer, intStartPrinting As Integer, some_var As Integer, intLinearizeFile As Integer, _
      grade As String, count As Integer, currentPage As Integer
